...
public class FileController {
    ...
    public void work(HttpParams httpParams) throws Exception {
        String path = httpParams.getFullHttpRequest().uri().substring(1);
        ...
        hf.setFile(f);
        hf.setName(name);
        hf.setContentType(MimeTypeEnum.getContentType(type));
        NettyHttpResponseUtils.responseFile(httpParams, hf);
    }
    ...
    public enum MimeTypeEnum {
        ...
        MPEG4("mp4","mp4","video/mp4"),
        M3U8("m3u8","m3u8","application/x-mpegURL"),
        _3GP("3gp","3gp","video/3gpp"),
